...
class content_tag {
    ...
    public function cmsware_node($data) {

    }
    public function cmsware_nodelist($data) {
    ...
    private function replaceTitle($str) {
        $search = array('c.title', 'c.s_name', 'c.degreetype', 'c.companyname', 'c.userfullname', 'c.schoolname', 'c.about_schoolid');
        $replace = array('i.title', 'i.title', 'i.title', 'i.title', 'i.title', 'i.title', 'i.title');
